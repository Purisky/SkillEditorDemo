...
namespace Leopotam.EcsLite {
    ...
    public static class EcsEntityExtensions {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Add<T>(this int entity)
            where T : struct =>
        ref EcsPool<T>.Pool.Add(entity);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Add<T>(this int entity, T value)
            where T : struct
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Add<T>(this EcsPackedEntity entity)
            where T : struct
            => ref entity.Id.Add<T>();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Add<T>(this EcsPackedEntity entity, T value)
            where T : struct
            => ref entity.Id.Add(value);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Get<T>(this int entity)
            where T : struct =>
ref EcsPool<T>.Pool.Get(entity);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Get<T>(this EcsPackedEntity entity)
            where T : struct
            => ref entity.Id.Get<T>();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T GetAdd<T>(this int entity)
            where T : struct =>
ref EcsPool<T>.GetAdd(entity);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T GetAdd<T>(this EcsPackedEntity entity)
            where T : struct =>
ref entity.Id.GetAdd<T>();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Set<T>(this int entity, T value)
            where T : struct
            => ref EcsPool<T>.SetAdd(entity, value);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T Set<T>(this EcsPackedEntity entity, T value)
            where T : struct
            => ref entity.Id.Set(value);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T? TryGet<T>(this EcsPackedEntity entity)
    where T : struct => entity.Id.TryGet<T>();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
